...
media_y = y.mean()
rmse_porcentaje = (mean_squared_error(
    y_test, y_pred, squared=False) / media_y) * 100
...
# Mostrar resultados
print(f"Mejor grado del polinomio: {
      modelos_grid.best_params_['polynomialfeatures__degree']}\n")
